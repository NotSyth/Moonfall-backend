...
// mount feature routes (loaded if present)
const mounts=[
['src/auth.js','/auth'],
...
// minimal oauth stubs (for older clients that ping these)
...
// content pages (news + lobby labels)
...
// presence stubs (compatible with friends.js use)
